...
export SKIP_IMAGES;            SKIP_IMAGES=$(bashio::config 'skip_images')
export SKIP_VIDEOS;            SKIP_VIDEOS=$(bashio::config 'skip_videos')
export SKIP_AUDIO;             SKIP_AUDIO=$(bashio::config 'skip_audio')
